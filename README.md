# NLP-Chatbots
This is my repository for the seminar "As We May Speak: From NLP to Chatbot"


In the folder "FinalProject_DetectiveGame" you can find my Final Project of the seminar.
